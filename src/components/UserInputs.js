...
function UserInputs() { // function component with inputs for customer/user information
    return <> {/* return multiple elements */}
        ...
        <UserInfoInput name = "firstname" label = "First name" type = "text" placeholder = "John" /> {/* Input for first name */}
        <UserInfoInput name = "lastName" label = "Last name" type = "text" placeholder = "Smith" /> {/* Input for last name */}
